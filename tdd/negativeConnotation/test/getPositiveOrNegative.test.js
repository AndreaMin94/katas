...
import positiveOrNegative from "../src/getPositiveOrNegative";
describe("positiveOrNegative", () => {
    it("should return false if first letter is between a and m case insensitive", () => {
        expect(positiveOrNegative("A")).toBe(false);
    });
    it("should return true if first letter is between n and z case insensitive", () => {
        expect(positiveOrNegative("T")).toBe(true);
    })
})